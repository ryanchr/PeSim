...
enum md_fu_class md_op2fu[OP_MAX] = {
  FUClamd_NA, /* NA */
#define DEFINST(OP,MSK,NAME,OPFORM,RES,FLAGS,O1,O2,O3,I1,I2,I3,I4) (md_fu_class)RES,
#define DEFUOP(OP,NAME,OPFORM,RES,FLAGS,O1,O2,O3,I1,I2,I3,I4) (md_fu_class)RES,
...
#define CONNECT(OP)							\
    ...
    if (debugging && md_opoffset[OP])					\
      printf("doubly defined opoffset, inst=`%s', op=%d, offset=%d",	\
	    #OP, (int)(OP), offset);					\
