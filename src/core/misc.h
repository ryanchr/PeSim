...
void
_fatal(char *file, const char *func, int line, const char *fmt, ...)
...
void
_warn(char *file, const char *func, int line, const char *fmt, ...);
#else /* !__GNUC__ */
void
warn(const char *fmt, ...);
#endif /* !__GNUC__ */
...
void
_warn(const char *file, char *func, int line, char *fmt, ...);
#else /* !__GNUC__ */
void
warn( const char *fmt, ...);
#endif /* !__GNUC__ */
...
void
_debug(char *file, const char *func, int line, const char *fmt, ...);
#else /* !__GNUC__ */
void
debug(char *fmt, ...);
#endif /* !__GNUC__ */
