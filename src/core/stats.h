...
enum stat_class_t {
  ss_sc_int = 0,			/* integer stat */
  ss_sc_uint,			/* unsigned integer stat */
#ifdef HOST_HAS_QWORD
  ss_sc_qword,			/* qword integer stat */
  ss_sc_sqword,			/* signed qword integer stat */
#endif /* HOST_HAS_QWORD */
  ss_sc_float,			/* single-precision FP stat */
  ss_sc_double,			/* double-precision FP stat */
  ss_sc_dist,			/* array distribution stat */
  ss_sc_sdist,			/* sparse array distribution stat */
  ss_sc_formula,			/* stat expression formula */
  ss_sc_NUM
};
...
struct stat_stat_t {
  ...
  enum stat_class_t ss_sc;		/* stat class */
